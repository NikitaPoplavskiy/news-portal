...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        if (! $this->app->runningInConsole()) {
            ...
            view()->composer(
                [
                    'frontend.layout.partials.header2',
                    'frontend.layout.partials.footer2'
                ], 
                function($view) {
            ...
            view()->composer('frontend.layout.partials.mainmenu2', function($view) {
                $categories = Category::all();
                $view->with('mainmenus', $categories);
            });
            ...
            view()->composer('frontend.pages.sidebar2', function($view) {
