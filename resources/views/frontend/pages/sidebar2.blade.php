    ...
    <div class="sidebars-area">
        ...
        <div class="single-sidebar-widget most-popular-widget">
            ...
            <div class="single-list flex-row d-flex">
                ...
                <div class="details">
                    <a href="{{ route('page.news', $popular->slug) }}">
                        <h6>{!! $popular->title !!}</h6>
                    </a>
                    <ul class="meta">
                        <li><a href="#"><span class="lnr lnr-calendar-full"></span>{!! $popular->source_date !!}</a></li>
                        <li><a href="#"><span class="lnr lnr-eye"></span>{!! $popular->view_count !!}</a></li>
                    </ul>
                </div>
            </div>
            @endforeach
