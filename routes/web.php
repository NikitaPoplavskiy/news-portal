...
Route::get('/page/terms', 'FrontController@pageTerms')->name('page.terms');
Route::get('/page/privacy', 'FrontController@pagePrivacy')->name('page.privacy');
Route::get('/page/about', 'FrontController@pageAbout')->name('page.about');
Route::get('/page/contact', 'FrontController@pageContact')->name('page.contact');
Route::get('/page/all-news', 'FrontController@pageAllNews')->name('page.all-news');

// FILTER
Route::post('/page/filter-news', 'FrontController@filterNews')->name('filter-news');


// LOAD MORE
Route::post('/page/load-more', 'FrontController@loadMore')->name('load-more');
...
Route::group(['prefix'=>'admin','as'=>'admin.','middleware' => ['auth','roles'], 'roles' => ['admin']], function(){
    ...
    // Route::get('sources/getNews','NewsCollectorController@getNews')->name('sources.getNews');
    Route::get('sources/getNews','NewsCollectorController@getNews')->name('sources.getNews');
